 ...
 * Pass devices/analysisResults when designer local state differs from persisted project.
 */
export async function downloadNfpaDesignReportPdf(rawProject, opts = {}) {
  const project = {
    ...rawProject,
    devices: opts.devices ?? rawProject?.devices ?? [],
