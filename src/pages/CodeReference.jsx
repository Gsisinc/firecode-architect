...
import { ArrowLeft, Search, ChevronDown, ChevronRight, BookOpen, AlertTriangle, CheckCircle2, XCircle, Info } from 'lucide-react';
...
const CODE_DATA = {
  ...
  'M': {
    ...
    fireAlarm: { required: 'Occupant load ≥ 500 OR >100 persons above/below discharge level', ref: 'IBC §907.2.7' },
    voiceEvac: { required: 'Not typically required (covered malls may need it)', ref: 'IBC §907.2.7' },
    sprinkler: { required: 'Floor area > 12,000 sf per floor OR >3 stories', ref: 'IBC §903.2.7' },
    pullStations: { required: 'Yes', exception: 'Fully sprinklered: one station at AHJ-directed location', ref: 'IBC §907.2.7' },
    smokeDetection: { required: 'FACP protection + common areas', ref: 'NFPA 72 §26.2' },
    coDetection: { required: 'No (unless fuel-burning appliances)', ref: 'IBC §915' },
    notification: 'Horn/Strobe throughout. Covered malls: occupant notification not required if constantly attended location with voice capability.',
    specialNotes: [
      ...
      'Food courts: smoke detection may need to be heat detection near cooking equipment',
    ],
  },
  'R-1': {
